...
def vggish_preprocess(x, fs):
    """
    Rewrite preprocess of VGGish to allow batch input

    from https://github.com/harritaylor/torchvggish/blob/master/torchvggish/vggish_input.py
    """
...
def waveform_to_examples(x, fs, return_tensor=True):
    """
    allow batch input

    https://github.com/harritaylor/torchvggish/blob/master/torchvggish/vggish_input.py
    """
    # Convert to mono.
    ...
    if fs != SAMPLE_RATE:
        data = resampy.resample(x, fs, SAMPLE_RATE)
